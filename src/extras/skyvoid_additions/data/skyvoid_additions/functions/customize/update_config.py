...
i = 0
for settings in setting_pages:
  i += 1
  tellraw @s [
      "",
      {
        "text": f"Skyblock Additions Config ({i}/8)  ",
        "color": "yellow",
        "clickEvent": {
          "action": "open_url",
  ...
  for S in settings:
    actionbar = "['',{'text':'" + S.name + ": ','color':'light_purple'},{'score':{'name':'" + S.id + "','objective':'skyvoid_config'},'color':'gold'}]"
    tellraw @s [
      "",
      {
        "text": S.name,
      ...
      },
      {
        ...
        "clickEvent": {
          "action": "run_command",
          "value": f"/scoreboard players set {S.id} skyvoid_config 1"
        },
        "hoverEvent":{
          "action":"show_text",
          "contents":[
      ...
      },
      {
        ...
        "clickEvent": {
          "action": "run_command",
          "value": f"/scoreboard players set {S.id} skyvoid_config 0"
        },
        "hoverEvent":{
          "action":"show_text",
          "contents":[
      ...
      },
      {
        ...
        "clickEvent": {
          "action": "run_command",
          "value": f"/scoreboard players reset {S.id} skyvoid_config"
        },
        "hoverEvent":{
          "action":"show_text",
          "contents":[
