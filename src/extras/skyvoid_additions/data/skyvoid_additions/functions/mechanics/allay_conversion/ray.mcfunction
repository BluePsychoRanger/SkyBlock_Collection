...
# check block
execute store success score $found skyvoid_additions align xyz positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ note_block as @e[type=vex,scores={skyvoid_waiting=1..},distance=..10,limit=1] run function skyvoid_additions:mechanics/allay_conversion/check_note_block
