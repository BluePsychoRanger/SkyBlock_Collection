...
data modify entity @s Pos[0] set from storage skyvoid_vanilla_oneblock:temp pos.x
data modify entity @s Pos[2] set from storage skyvoid_vanilla_oneblock:temp pos.z
