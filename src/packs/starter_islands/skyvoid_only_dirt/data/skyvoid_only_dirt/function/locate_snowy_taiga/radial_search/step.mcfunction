...
execute if score $generated skyvoid_only_dirt matches 0 if score $search_count skyvoid_only_dirt matches 72.. unless score $offset skyvoid_only_dirt matches 32.. at @s rotated 0 0 run function skyvoid_only_dirt:locate_snowy_taiga/radial_search/start

# fallback if the biome wasn't found
execute if score $generated skyvoid_only_dirt matches 0 if score $search_count skyvoid_only_dirt matches 72.. if score $offset skyvoid_only_dirt matches 32.. run function skyvoid_only_dirt:locate_snowy_taiga/radial_search/fallback
