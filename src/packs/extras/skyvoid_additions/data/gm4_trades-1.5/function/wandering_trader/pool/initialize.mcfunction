...
# run from gm4_trades-1.5:wandering_trader/create_pool
...
execute as @e[type=trader_llama,tag=gm4_trade_option,tag=!gm4_pooled_trade_option,limit=1,sort=arbitrary] run function gm4_trades-1.5:wandering_trader/pool/collect_trades
