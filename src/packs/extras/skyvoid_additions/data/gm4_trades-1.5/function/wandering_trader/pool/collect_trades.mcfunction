...
# run from gm4_trades-1.5:wandering_trader/pool/initialize, loops itself
...
execute as @e[type=trader_llama,tag=gm4_trade_option,tag=!gm4_processed_trade_option,limit=1,sort=arbitrary] run function gm4_trades-1.5:wandering_trader/pool/collect_trades
