# converts stone item to an ore
# @s = stone items inside a magma cube
# located at @s
...
loot spawn ~ ~ ~ loot skyvoid_additions:gameplay/ores_from_magma_cubes/convert_stone
