...
execute if score $search_count skyvoid_vanilla_oneblock matches 72.. if score $offset skyvoid_vanilla_oneblock matches 32.. run schedule function skyvoid_vanilla_oneblock:locate_snowy_taiga/send_error 1t
