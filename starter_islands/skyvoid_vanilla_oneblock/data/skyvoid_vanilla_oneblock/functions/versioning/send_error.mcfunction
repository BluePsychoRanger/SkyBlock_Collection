...
execute if score skyvoid_worldgen load.status matches ..-1 run tellraw @a [{"text":"Vanilla One Block was not generated because it requires an older version of skyvoid_worldgen","color":"red"}]
