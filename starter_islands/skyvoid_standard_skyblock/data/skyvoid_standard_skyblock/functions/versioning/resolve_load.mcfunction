execute if score skyvoid_worldgen load.status matches 0 unless score skyvoid_vanilla_oneblock load.status matches 1.. run scoreboard players set skyvoid_standard_skyblock load.status 1
