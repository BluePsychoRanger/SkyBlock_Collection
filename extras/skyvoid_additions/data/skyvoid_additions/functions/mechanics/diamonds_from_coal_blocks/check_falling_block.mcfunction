...
execute at @s[tag=skyvoid_additions_falling_anvil] positioned ~ ~-1 ~ as @e[type=item,nbt={Item:{id:"minecraft:coal_block",Count:64b},OnGround:1b},distance=..0.5] run data merge entity @s {Item:{id:"minecraft:diamond",Count:1b}}
