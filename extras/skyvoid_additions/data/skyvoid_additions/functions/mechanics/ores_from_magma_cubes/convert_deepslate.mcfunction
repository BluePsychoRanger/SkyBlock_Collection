# converts deepslate item to an ore
# @s = deepslate items inside a magma cube
# located at @s
...
tag @s add skyvoid_magma_deepslate
...
loot spawn ~ ~ ~ loot skyvoid_additions:gameplay/ores_from_magma_cubes/convert_deepslate
