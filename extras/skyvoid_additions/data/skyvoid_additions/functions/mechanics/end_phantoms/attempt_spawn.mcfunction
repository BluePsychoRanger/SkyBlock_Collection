...
execute if score $air_count skyvoid_additions matches 27 run summon phantom ~ ~ ~ {DeathLootTable:"skyvoid_additions:entities/end_phantoms/end_phantom",Health:60.0f,Size:3,Tags:["skyvoid_additions_end_phantom"],Attributes:[{Name:"generic.max_health",Base:60.0d}]}
